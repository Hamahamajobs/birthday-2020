...
<div id="hama-top-message-wrapper">
        <h2>やったね！！！Normalお宝ゲット！</h2>
        <h2>大魔神カジュから、Normalお宝をもらおう</h2>  
</div>

<div class="wrapper">
        <a href="line-message" class="fancy-button pop-onhover bg-gradient1 pulse-grow"><span id="hama-btn-messages" style="font-size:150%;">冒険へ戻る！</span></a>
</div><!-- /.wrapper -->
<?php $__env->stopSection(); ?>



<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/hamadakazutaka/Main/laravel_app/BirthdayProject/resources/views/getNormalTreger.blade.php ENDPATH**/ ?>