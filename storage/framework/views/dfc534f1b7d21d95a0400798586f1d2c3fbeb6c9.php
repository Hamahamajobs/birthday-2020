...
<div id="hama-top-message-wrapper">
    ...
    <p>30XX年、アンドロメダ銀河には大秘宝"スペースダイヤモンド"があった。</p>
    <p>それを見つける為、「宇宙探検家わにゃ」は、仲間の「ピン太郎」「ピン子」と一緒に、宇宙へ旅立つのであった。</p><br><br><br>
    <p>　　　　　　今、「宇宙探検家わにゃ」の大冒険が始まる......！！</p>
</div>

<div class="wrapper">
        <a href="line-message" class="fancy-button pop-onhover bg-gradient1 pulse-grow"><span id="hama-btn-messages" style="font-size:150%;">いざ、冒険へ！</span></a>
</div><!-- /.wrapper -->
<?php $__env->stopSection(); ?>



<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/hamadakazutaka/Main/laravel_app/BirthdayProject/resources/views/top.blade.php ENDPATH**/ ?>