...
<div class="wrapper">
        <a href="rockPassword" class="fancy-button pop-onhover bg-gradient1 pulse-grow"><span id="hama-btn-messages" style="font-size:150%;">いざ、冒険へ！</span></a>
</div><!-- /.wrapper -->
<?php $__env->stopSection(); ?>



<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/hamadakazutaka/Main/laravel_app/BirthdayProject/resources/views/getTreger.blade.php ENDPATH**/ ?>